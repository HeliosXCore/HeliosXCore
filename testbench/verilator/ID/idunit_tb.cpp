...
int main(int argc, char **argv, char **env) {
    ...
    while (sim_time < MAX_SIM_TIME) {
        ...
        if (sim_time == 6) {
            ...
            std::cout << "IDUnit Test 1 Pass!" << std::endl;
        }
        ...
        if (sim_time == 8) {
            ...
            std::cout << "IDUnit Test 2 Pass!" << std::endl;
        }
        ...
        if (sim_time == 10) {
            ...
            std::cout << "IDUnit Test 3 Pass!" << std::endl;
        }
        ...
        if (sim_time == 12) {
            ...
            assert(dut->dmem_size_1_o==0x2);
            assert(dut->dmem_type_1_o==0x2);
            std::cout << "IDUnit Test 4 Pass!" << std::endl;
        }
        sim_time++;
    }
